    ...
    <footer className="footer">
      ...
      <div className="footer-right">
        <div className="footer-socials">
          <a href="https://www.linkedin.com/in/umang-khemka-9ab713295/" aria-label="LinkedIn" title="LinkedIn">
          ...
          <a href="https://leetcode.com/u/Khemka2005/" aria-label="LeetCode" title="LeetCode">
          ...
          <a href="https://x.com/UmangKhemka2005" aria-label="X" title="X">
        ...
        <p className="footer-copy">© 2026 UMANG KHEMKA</p>
      </div>
    </footer>
  );
}
